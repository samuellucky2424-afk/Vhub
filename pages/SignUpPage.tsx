                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-12 py-3.5 rounded-xl border border-[#e6e2db] dark:border-white/10 bg-white dark:bg-background-dark text-[#181511] dark:text-white focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all font-medium"
                        placeholder="••••••"
                        required
                      />
                      <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-[#897b61] hover:text-[#181511] dark:hover:text-white transition-colors"
