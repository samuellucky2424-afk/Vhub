-- =============================================================
-- STEP 1: Add phone_number column to orders table (if missing)
-- =============================================================
ALTER TABLE public.orders
  ADD COLUMN IF NOT EXISTS phone_number text;

-- STEP 2: Back-fill phone_number from existing metadata for old orders
...
WHERE phone_number IS NULL
  AND (
    ...
    metadata->>'number' IS NOT NULL OR
    metadata->>'phone_number' IS NOT NULL
  );

SELECT 'phone_number column added and back-filled' AS step1_result;

-- =============================================================
-- STEP 3: Update atomic_purchase_verification to save phone_number
--         as a dedicated column AND fix otp_code initialization
-- =============================================================
...
BEGIN
  ...
  -- ─── 5. Create order record (with phone_number column) ───
  ...
  -- otp_code = null, full_sms = '' so we never show placeholder text as the OTP
...
SELECT 'atomic_purchase_verification updated successfully' AS step3_result;
